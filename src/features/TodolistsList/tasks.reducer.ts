...
import { createAppAsyncThunk } from "../../utils/createAppAcyncThunk";
...
;
export const updateTaskTC = createAppAsyncThunk<any, UpdateTaskType>(`${slice.name}/updateTask`, async (arg, thunkAPI) => {
